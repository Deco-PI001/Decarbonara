...
def insert_log_zeile(zeile, p_datei, p_satznummer, anzahl_fehler):
    ...
    try:
        ...
        print('Fehler bei Insert Log-zeile')
...
def insert_log_zeile_messwert(zeile, p_datei, p_satznummer, anzahl_fehler):
    ...
    try:
        ...
        print('Fehler beim Datensatz anlegen')
...
log_pfad = '/Users/Karsten/Alles/Kunden/Decarbonara_Git/Decarbonara/Daten/'
log_datei = 'devlog*'
satznummer = 0
anzahl_dateien = 0
anzahl_saetze = 0
...
db_verbindung = mysql.connector.connect(database='DeCarbonara',
                                            user='root',
                                        password='DeCarbonaras#2021', auth_plugin='mysql_native_password') 
